...
def patch_db(engine, monkeypatch):
    ...
    import financial_pipeline.routes.dashboard as dashboard_mod
    import financial_pipeline.routes.inbox as inbox_mod
    import financial_pipeline.routes.settings as settings_mod
    ...
    monkeypatch.setattr(dashboard_mod, "async_session", test_session)
    monkeypatch.setattr(inbox_mod, "async_session", test_session)
    monkeypatch.setattr(settings_mod, "async_session", test_session)
