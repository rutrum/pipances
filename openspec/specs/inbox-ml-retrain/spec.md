## Purpose
Allow users to re-run ML predictions on pending transactions mid-session, using newly approved transactions as additional training data to improve predictions for remaining pending transactions.
