...
All inline edit endpoints (edit-description, edit-external, edit-category) SHALL return HTTP 404 when the requested transaction ID does not exist, instead of crashing with an unhandled error.
