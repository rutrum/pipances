...
The app SHALL have a Data page at `/data` with a DaisyUI sidebar menu on the left and a content pane on the right.
...
- **THEN** the Configuration section SHALL contain: Accounts, Importers
- **THEN** the Data section SHALL contain: Transactions, External Accounts, Categories, Import History
